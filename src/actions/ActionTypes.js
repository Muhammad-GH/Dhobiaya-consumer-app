...
export const ADD_TO_CART_FOR_DELETE = 'ADD_TO_CART_FOR_DELETE';
export const ADD_TO_CART_FOR_UNDELETE = 'ADD_TO_CART_FOR_UNDELETE';
export const SERVICE_ID = 'SERVICE_ID';
export const ADD_TOTAL_ITEMS_PLUS = 'ADD_TOTAL_ITEMS_PLUS';
export const ADD_TOTAL_ITEMS_MINUS = 'ADD_TOTAL_ITEMS_MINUS';
export const TOTAL_ITEMS_DELETE = 'TOTAL_ITEMS_DELETE';
export const TOTAL_KG_DELETE = 'TOTAL_KG_DELETE';
export const ADD_TOTAL_KG = 'ADD_TOTAL_KG';
export const PRODUCT_RESET = 'PRODUCT_RESET';
export const PRODUCT_LIST_RESET = 'PRODUCT_LIST_RESET';
export const GETTOTALITEMANDKGS = 'GETTOTALITEMANDKGS';
...
export const CONFIRM_ORDER_EDIT = 'CONFIRM_ORDER_EDIT';
export const RESET = 'RESET';
export const SPECIAL_REQUEST = 'SPECIAL_REQUEST';
export const SHOW_EDIT_BTN = 'SHOW_EDIT_BTN';
