      ...
      <Container style={{backgroundColor: colors.theme_bg_two}}>
        <Header androidStatusBarColor={colors.theme_bg} style={styles.header}>
          ...
          <Body style={styles.header_body}>
            <Title style={styles.title}>APPLY COUPONS</Title>
          </Body>
          <Right />
        </Header>
        <ScrollView>
...
const styles = StyleSheet.create({
  ...
  promo_code: {
    ...
    paddingRight: 10,
    paddingBottom: 5,
    paddingLeft: 10,fontFamily:'SFUIDisplay-Light',
  },
  apply: {
    fontSize: 14,
    fontWeight: 'bold',
    color: colors.theme_fg,fontFamily:'SFUIDisplay-Light',
  },
  promo_name: {
    fontSize: 15,
    fontWeight: 'bold',
    color: colors.theme_fg_two,
    marginTop: 10,fontFamily:'SFUIDisplay-Light',
  },
  description: {
    fontSize: 12,
    marginTop: 5,fontFamily:'SFUIDisplay-Light',
  },
});
